...
bot.on("ready", () => {
    ...
    console.log(`ezBot has started, with ${bot.users.size} users, in ${bot.user.channels.size} channels of ${bot.user.guilds.size} guilds.`); 
    bot.user.setActivity(`In ${bot.user.guilds.size} Servers | $help`);
  });
